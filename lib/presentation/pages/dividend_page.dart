        ...
        builder: (context, stockState) {
          return BlocBuilder<DividendsBloc, DividendsState>(
            builder: (context, state) {
              // Only calculate on initial load if we haven't processed these stocks yet
              if (state is DividendsInitial && 
                  stockState is StockLoaded && 
                  context.read<DividendsBloc>().lastProcessedStockCount != stockState.stocks.length) {
              ...
              switch (state) {
                case DividendsInitial():
                  return const Center(
                    child: Text('Loading dividend metrics...'),
                  );
